...
export function InventoryUI() {
  ...
  return (
    <div 
      className="absolute inset-0 z-50 flex items-center justify-center bg-black/50 pointer-events-auto select-none" 
      onContextMenu={event => event.preventDefault()}
      onMouseDown={handleBackgroundClick}
    >
      <div style={{ width: INVENTORY_WIDTH * 1.5, height: INVENTORY_HEIGHT * 1.5 }}>
      <div
